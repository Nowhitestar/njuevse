		...
		if (cell == null || graph.getSelectionCells().length > 1) {
			...
			if (drupal_node_ID == -1 && slids.length == 0) {
				if (is_ebook) {
					...
					topDesc = "<center><br><br><img src='" + builder_path + "/images/nju.png' width=130 /><br><br><big><strong>区域物质循环动态虚拟仿真系统</strong></big><br/><br/><br/><div style = padding:10px>区域物质循环动态虚拟仿真系统是南京大学国家级“社会经济环境系统虚拟仿真实验教学中心”环境虚拟仿真平台开发的一套虚拟仿真实验系统，是支撑环境规划与管理专业教学和科研的基础平台。<br><br>该系统立足于强大的互联网技术与系统动力学模拟技术，旨在将环境系统分析、物质循环过程模拟、生命周期评价与管理等学科内容进行融合与集成，为环境及相关专业学生培养提供实验条件。</div></center>";
				}
			} else {
